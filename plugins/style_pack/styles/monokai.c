...
PACKABLE_STYLE(monokai) {
    ...
    s.inactive.flags      = ATTR_FG_KIND_BITS(ATTR_KIND_256) | ATTR_BG_KIND_BITS(ATTR_KIND_256);
    s.inactive.fg         = 231;
    s.inactive.bg         = 232;
    ...
    s.search.flags        = ATTR_FG_KIND_BITS(ATTR_KIND_256) | ATTR_BG_KIND_BITS(ATTR_KIND_256) | ATTR_BOLD | ATTR_INVERSE;
    s.search.fg           = 24;
    s.search.bg           = 231;

    s.search_cursor.flags = ATTR_FG_KIND_BITS(ATTR_KIND_256) | ATTR_BG_KIND_BITS(ATTR_KIND_256) | ATTR_BOLD | ATTR_INVERSE;
    ...
    s.attention.flags     = ATTR_FG_KIND_BITS(ATTR_KIND_256);
    s.attention.fg        = 197;
    ...
    s.code_keyword.flags  = ATTR_FG_KIND_BITS(ATTR_KIND_256) | ATTR_BOLD;
    ...
    s.code_fn_call.flags  = ATTR_FG_KIND_BITS(ATTR_KIND_256);
