...
#define color_fg            MAYBE_CONVERT(RGB_32_hex(ACB3B5))
#define color_bg            MAYBE_CONVERT(RGB_32_hex(111a1f))
...
#define color_attent        MAYBE_CONVERT(RGB_32_hex(810002))
#define color_assoc         MAYBE_CONVERT(RGB_32_hex(9B9257))
#define color_comment       MAYBE_CONVERT(RGB_32_hex(545759))
#define color_keyword       MAYBE_CONVERT(RGB_32_hex(738C9C))
#define color_pp            color_keyword
#define color_fn            MAYBE_CONVERT(RGB_32_hex(8D7856))
#define color_num           MAYBE_CONVERT(RGB_32_hex(9B9257))
#define color_str           MAYBE_CONVERT(RGB_32_hex(798362))
#define color_ty            MAYBE_CONVERT(RGB_32_hex(9B9257))
#define color_cf            MAYBE_CONVERT(RGB_32_hex(9B9257))
...
/*     s.selection.bg        = s.active.fg; */
    ...
    yed_plugin_set_style(self, "elly", &s);
